export default [
  ...
  {
    name: 'Texas Legislature Session Countdown',
    image: 'countdown.png',
    blurb:
  ...
  },
  {
    ...
    image: 'node-chat.png',
    blurb:
      'A chat app built with Node.js and socket.io. Includes unique (not secure) user login and private chat rooms as well as the ability to send your location to others in the same chat room using Google Maps API.',
