    ...
    return (
      <div className="resume-container">
        ...
        <div className="resume">
          ...
          <ul className="experience">{experience}</ul>
          ...
          <div className="education">
            <p className="ed-school">The Iron Yard</p>
            <p className="ed-degree">Front-End Engineering</p>
            <p className="ed-loc">Austin, TX</p>
          </div>
          <h3 className="resume-title">Achievements</h3>
          <p className="achievements">
            Texas Democracy Foundation Next Generation Leaders 2012, City of
            Austin Impact Fee Committee Member 2010-2011, Scuba certified, CPR
            certified, youth soccer coach
          </p>
